...
class ManipulationObjectCfg(RigidObjectCfg):
    ...
    init_state = RigidObjectCfg.InitialStateCfg(
        pos=(0.6, 0.0, 0.04), rot=(1.0, 0.0, 0.0, 0.0), lin_vel=(0.0, 0.0, 0.0), ang_vel=(0.0, 0.0, 0.0)
    )
...
@configclass
class ChemistryV0EnvCfg(IsaacEnvCfg):
    # General Settings
    env: EnvCfg = EnvCfg(num_envs=1024, env_spacing=2.5, episode_length_s=30.0)
    ...
    sim: SimCfg = SimCfg(
        ...
        substeps=1,
        physx=PhysxCfg(
            gpu_found_lost_aggregate_pairs_capacity=512 * 1024* 10,
            gpu_total_aggregate_pairs_capacity=6 * 1024 *10,
        ),
    )
    ...
    object1: ManipulationObjectCfg = ManipulationObjectCfg()
    object1.init_state.pos = (0.6, -0.2, 0.04)
